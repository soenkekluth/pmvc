 ...
 * @constructor
 */var Observer=function(){function Observer(notifyMethod,notifyContext){_classCallCheck(this,Observer);/**
     ...
     * @private
     * @type {Object}
     */this.context=null;this.setNotifyMethod(notifyMethod);this.setNotifyContext(notifyContext)}/**
   ...
   * @return {void}
   */Observer.prototype.setNotifyMethod=function setNotifyMethod(notifyMethod){this.notify=notifyMethod};/**
   ...
   *
   * @return {void}
   */Observer.prototype.setNotifyContext=function setNotifyContext(notifyContext){this.context=notifyContext};/**
   * Get the Function that this Observer will invoke when it is notified.
   *
   * @private
   * @return {Function}
   */Observer.prototype.getNotifyMethod=function getNotifyMethod(){return this.notify};/**
   * Get the Object that will serve as the Observers callback execution context
   *
   * @private
   * @return {Object}
   */Observer.prototype.getNotifyContext=function getNotifyContext(){return this.context};/**
   * Notify the interested object.
   *
   * @param {puremvc.Notification} notification
   *  The Notification to pass to the interested objects notification method
   * @return {void}
   */Observer.prototype.notifyObserver=function notifyObserver(notification){this.notify.call(this.context,notification);// console.log(notification);
...
// this.notify.bind(this.context);
   ...
   *
   * @return {boolean}
   */Observer.prototype.compareNotifyContext=function compareNotifyContext(object){return object===this.context};return Observer}();exports.default=Observer;module.exports=exports['default'];