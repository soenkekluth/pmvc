 ...
 *
 * @constructor
 */var Notifier=function(){function Notifier(){_classCallCheck(this,Notifier);/**
       * @protected
     ...
     * @return {void}
     */Notifier.prototype.sendNotification=function sendNotification(notificationName,body,type){var facade=this.getFacade();if(facade){facade.sendNotification(notificationName,body,type)}};/**
   ...
   * @return {void}
   */Notifier.prototype.initializeNotifier=function initializeNotifier(key){this.multitonKey=key;this.facade=this.getFacade()};/**
   * Retrieve the Multiton Facade instance
   *
   *
   * @protected
   * @return {puremvc.Facade}
   */Notifier.prototype.getFacade=function getFacade(){if(!this.multitonKey){throw new Error(Notifier.MULTITON_MSG)}return _Facade2.default.getInstance(this.multitonKey)};/**
   * @ignore
   ...
   * @const
   * @type string
   */return Notifier}();Notifier.MULTITON_MSG="multitonKey for this Notifier not yet initialized!";exports.default=Notifier;module.exports=exports["default"];