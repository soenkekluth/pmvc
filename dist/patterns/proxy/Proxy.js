 ...
 * @constructor
 */var Proxy=function(_Notifier){_inherits(Proxy,_Notifier);function Proxy(proxyName,data){_classCallCheck(this,Proxy);/**
     * @ignore
     * The Proxys name.
     *
     * @protected
     * @type String
     */var _this=_possibleConstructorReturn(this,_Notifier.call(this));_this.proxyName=proxyName||Proxy.NAME;/**
     * @ignore
     * The Proxy's data object.
     *
     * @protected
     * @type Object
     */_this.data=null;if(data){_this.setData(data)}return _this}/**
   * Get the Proxy's name.
   *
   * @return {string}
   */Proxy.prototype.getProxyName=function getProxyName(){return this.proxyName};/**
   * Set the Proxy's data object
   *
   * @param {Object} data
   * @return {void}
   */Proxy.prototype.setData=function setData(data){this.data=data};/**
   * Get the Proxy's data object
   *
   * @return {Object}
   */Proxy.prototype.getData=function getData(){return this.data};/**
   * Called by the {@link puremvc.Model Model} when
   * the Proxy is registered.
   *
   * @return {void}
   */Proxy.prototype.onRegister=function onRegister(){return};/**
   * Called by the {@link puremvc.Model Model} when
   * the Proxy is removed.
   *
   * @return {void}
   */Proxy.prototype.onRemove=function onRemove(){return};return Proxy}(_Notifier3.default);Proxy.NAME="Proxy";exports.default=Proxy;module.exports=exports["default"];