'use strict';Object.defineProperty(exports,'__esModule',{value:true});exports.default=undefined;var _Model=require('../../core/Model');var _Model2=_interopRequireDefault(_Model);var _View=require('../../core/View');var _View2=_interopRequireDefault(_View);var _Notification=require('../../patterns/observer/Notification');var _Notification2=_interopRequireDefault(_Notification);var _Controller=require('../../core/Controller');var _Controller2=_interopRequireDefault(_Controller);function _interopRequireDefault(obj){return obj&&obj.__esModule?obj:{default:obj}}function _classCallCheck(instance,Constructor){if(!(instance instanceof Constructor)){throw new TypeError('Cannot call a class as a function')}}/**
 ...
 */var Facade=function(){function Facade(key){_classCallCheck(this,Facade);if(Facade.instanceMap[key]){throw new Error(Facade.MULTITON_MSG)}/**
     * @ignore
   ...
   * @return {void}
   */Facade.prototype.sendNotification=function sendNotification(notificationName,body,type){var n=new _Notification2.default(notificationName,body,type);this.notifyObservers(n)};/**
